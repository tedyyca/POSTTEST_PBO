...
import tedyyca.model.*; //impor Sepatu dan Kategori dari package model
            ...
            switch (pilihan) {
                case 1 -> {
                    ...
                    while (true) {
                        ...
                        h = sc.nextDouble();
                        if (h >= 0) break;
                        System.out.println("Harga tidak boleh negatif! Silakan input kembali.");
                    }
                    ...
                    while (true) {
                        ...
                        s = sc.nextInt();
                        if (s >= 0) break;
                        System.out.println("Stok tidak boleh negatif! Silakan input kembali.");
                    }
                    sc.nextLine();

                    // nambah data baru lewat constructor
                    ...
                    if (dataSepatu.isEmpty()) {
                        ...
                        if (idx >= 0 && idx < dataSepatu.size()) {
                            ...
                            if (m.isEmpty() || k.isEmpty()) {
                                ...
                                spt.setMerk(m);
                                spt.getKategori().setNamaKategori(k);
                                spt.setHarga(h);
                                spt.setStok(s);

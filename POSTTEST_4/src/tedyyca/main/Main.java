            ...
            switch (pilihan) {
                case 1 -> {
                    ...
                    while (true) {
                        ...
                        if (!m.isEmpty()) break;
                        System.out.println("[!] Merk tidak tersedia, silakan ulangi.");
                    }
                    ...
                    while (true) {
                        ...
                        System.out.println("[!] Kategori tidak tersedia, silakan ulangi.");
                    }
                    ...
                    System.out.println("\n[√] Data " + m + " berhasil ditambahkan!");
                }

                case 2 -> {
                    if (dataSepatu.isEmpty()) {
                        System.out.println("\n[!] Belum ada sepatu yang ditambahkan.");
                    } else {
                        System.out.println("\n========== DAFTAR STOK SEPATU ==========");
                ...
                case 3 -> {
                    if (dataSepatu.isEmpty()) {
                        ...
                        if (idx >= 0 && idx < dataSepatu.size()) {
                            Sepatu sUpdate = dataSepatu.get(idx);
                            int pUpdate;
                            while (true) {
                                System.out.println("\n--- Update Harga ---");
                                System.out.println("1. Harga Normal\n2. Harga + Diskon");
                                System.out.print("Pilih (1-2): ");
                                pUpdate = sc.nextInt();
                                if (pUpdate == 1 || pUpdate == 2) break;
                            }
                            if (pUpdate == 1) {
                                System.out.print("Harga Baru: ");
                                sUpdate.setHarga(sc.nextDouble());
                            } else {
                                System.out.print("Harga Dasar: "); double hD = sc.nextDouble();
                                System.out.print("Diskon (%): "); double d = sc.nextDouble();
                                sUpdate.setHarga(hD, d);
                            }
